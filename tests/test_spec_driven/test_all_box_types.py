...
from spec_driven.box.registry import BOX_TYPE_REGISTRY, BOX_IMPL_REGISTRY
...
class BoxRegistryTests(unittest.TestCase):
    ...
    def test_registry_returns_correct_builder_class(self) -> None:
        from spec_driven.builders.sliding import SlidingBoxBuilder
        from spec_driven.builders.cap import CapBoxBuilder
        from spec_driven.builders.hinge import HingeBoxBuilder
        from spec_driven.builders.filament_hinge import FilamentHingeBoxBuilder
        from spec_driven.builders.magnetic import MagneticBoxBuilder
        from spec_driven.builders.no_lid import NoLidBoxBuilder
