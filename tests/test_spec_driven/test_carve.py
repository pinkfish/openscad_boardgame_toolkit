...
from spec_driven.box.shell import block, build_shell
from spec_driven.compartments.builder import CompartmentBuilder
from spec_driven.compartments.carve import build_contents, interior_mouth
...
class CompartmentCarveTests(unittest.TestCase):
    ...
    def test_a_shallow_compartment_falls_back_to_a_floor_bowl(self) -> None:
        ...
        from spec_driven.compartments.finger_hole import build_floor_scoop, build_scoop
    ...
    def test_a_deep_compartment_gets_a_wall_notch(self) -> None:
        from spec_driven.compartments.finger_hole import build_scoop, build_wall_scoop
