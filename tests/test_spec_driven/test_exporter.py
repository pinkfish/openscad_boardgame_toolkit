...
from spec_driven.box.registry import BOX_IMPL_REGISTRY, BOX_TYPE_REGISTRY, LIDLESS_BOX_TYPES
from spec_driven.compartments.sizing import RowItem, distribute_row_width, rows_from_placements
from spec_driven.enums import BoxType
from spec_driven.export.exporter import BoxExporter, PieceBounds
from spec_driven.export.hausdorff import mesh_digest, should_write
...
class RowSizingTests(unittest.TestCase):
    ...
    def test_placements_group_into_rows_by_y(self) -> None:
        from spec_driven.compartments.layout import CompartmentPlacement
