        ...
        if (solid_background) {
          ...
          intersection() {
            ...
            translate([-length * 5.5 / 4, -calc_width / 2, 0])
              Make3dStripedGrid(size=[length, calc_width], height=height, spacing=grid_spacing);
          }
        }
      ...
      if (background) {
        difference() {
          color("blue") translate([-length * 5 / 4, -length / 4, 0]) Make3dStripedGrid(
                size=[length, length], height=max(red_height, white_height), spacing=1.5
              );
  ...
  translate([-length / 2, -length / 4, 0]) intersection() {
      ...
      union() {
          ...
          color("blue") difference() {
              if (solid_background) {
                ...
                translate([-length / 4, 0, 0])
                  Make3dStripedGrid(size=[length, length / 2], height=blue_height, spacing=1.5);
              }
              intersection() {
                translate([0, length / 2, -0.5])
                  cuboid(
                    [length / 2 - 0.01, length / 4 - 0.01, max(white_height, red_height) + 1],
        ...
        union() {
          ...
          translate([length / 4, length * 3 / 8, 0]) UnionJack(
              length=length / 2, white_height=white_height,
    ...
    for (i = [0:1:4]) {
      for (j = [0:1:9]) {
        color("white") translate(
            [
              -top_bit_width / 2 + star_offset_length / 2 + star_offset_length * i + (j % 2 == 1 ? star_offset_length / 2 : 0),
  ...
  module Stripes(white_height, red_height) {
    difference() {
      ...
      translate([-width / 2 + stripe * 6.5, -length / 2 + top_bit_length / 2, -1])
        cuboid(
          [top_bit_width + 0.01, top_bit_length + 0.01, max(white_height, red_height) + 2],
          anchor=BOTTOM + LEFT
        );
    }
  }
    ...
    color("black") linear_extrude(height=height) resize([mult * calc_len, width])
          translate([-len_max + (len_max - len_min) / 2, -width_max + (width_max - width_min) / 2]) {
            ...
            polygon(
              bezpath_curve(
                [
                  [318.43762000000004, 263.36957],
                  [318.43762000000004, 263.36957],
                  [317.4825000000001, 263.40044],
                  [315.6684, 263.20112],
                  [304.3684, 261.95052],
                  [270.0794, 245.27612],
                  [229.5064, 220.98812],
                  [182.2964, 192.72812000000002],
                  [143.3064, 166.97812000000002],
                  [147.53640000000001, 160.24812],
                  [147.53640000000001, 160.24812],
                  [148.68730000000002, 158.21352],
                  [148.68730000000002, 158.21352],
                  [148.68730000000002, 158.21352],
                  [148.91395000000003, 158.28412],
                  [148.91395000000003, 158.28412],
                  [145.11025000000004, 169.68912],
                  [225.86195000000004, 215.86212],
                  [230.61595000000003, 218.80612],
                  [277.33995000000004, 247.75312],
                  [316.73095, 264.65711999999996],
                  [320.21695, 260.26412],
                  [320.21695, 260.26412],
                  [318.94875, 262.44512],
                  [318.94875, 262.44512],
            ...
            polygon(
              bezpath_curve(
                [
                  ...
                  [155.40136, 148.3863],
                  [155.8088, 147.7151],
                  [158.8567, 149.24970000000002],
                  [169.34179999999998, 153.506],
                  [190.0348, 156.4375],
                  [202.7548, 158.2411],
                  [219.6958, 159.5852],
                  [240.2968, 159.564],
                  [261.9868, 159.5419],
                  [278.84979999999996, 157.7878],
                  [292.1798, 155.8757],
                  [312.3848, 153.0958],
                  [323.2568, 147.92849999999999],
                  [324.9078, 146.6347],
                  [324.9078, 146.6347],
                  [326.3806, 149.0856],
                  [326.3806, 149.0856],
