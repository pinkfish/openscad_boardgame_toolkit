...
module PlayerBoxLid() // `make` me
{
    CapBoxLidWithLabel(width = player_box_width, length = player_box_length, height = player_box_height,
                       text_width = 50, text_height = 20, text_str = "Player", label_rotated = true);
}
...
{
    CapBoxLidWithLabel(width = resource_box_width, length = resource_box_length, height = resource_box_height,
                       text_width = 50, text_height = 20, text_str = "Mouse", label_rotated = true);
    translate([ resource_box_width + 10, 0, 0 ])
    {
        CapBoxLidWithLabel(width = resource_box_width, length = resource_box_length, height = resource_box_height,
                           text_width = 50, text_height = 20, text_str = "Sun", label_rotated = true);
        translate([ resource_box_width + 10, 0, 0 ])
        {
            CapBoxLidWithLabel(width = resource_box_width, length = resource_box_length, height = resource_box_height,
                               text_width = 50, text_height = 20, text_str = "Fish", label_rotated = true);
            translate([ resource_box_width + 10, 0, 0 ])
            {
                CapBoxLidWithLabel(width = resource_box_width, length = resource_box_length,
                                   height = resource_box_height, text_width = 50, text_height = 20, text_str = "Leaf",
                                   label_rotated = true);
                translate([ resource_box_width + 10, 0, 0 ])
                {
                    CapBoxLidWithLabel(width = resource_box_width, length = resource_box_length,
                                       height = resource_box_height, text_width = 50, text_height = 20,
...
{
    CapBoxLidWithLabel(width = nest_box_width, length = nest_box_length, height = nest_box_height, text_width = 50,
                       text_height = 20, text_str = "Nests", label_rotated = true);
}

module ExtraBitsBox() // `make` me
{
    MakeBoxWithCapLid(width = extra_bits_box_width, length = extra_bits_box_length, height = extra_bits_box_height,
...
{
    CapBoxLidWithLabel(width = extra_bits_box_width, length = extra_bits_box_length, height = extra_bits_box_height,
                       text_width = 50, text_height = 20, text_str = "Biome", label_rotated = true);
}
...
module SpinnerHolder() // `make` me
{
    ...
    {
        cuboid([ spinner_box_width, spinner_box_length, spinner_box_height ], rounding = 2,
...
{
    SlidingBoxLidWithLabel(width = card_box_width, length = card_box_length, text_width = 50, text_height = 20,
                           text_str = "Starting", label_rotated = true);
}
...
{
    SlidingBoxLidWithLabel(width = card_box_width, length = card_box_length, text_width = 50, text_height = 20,
                           text_str = "Achievement", label_rotated = true);
}
...
{
    SlidingBoxLidWithLabel(width = card_box_width, length = card_box_length, text_width = 50, text_height = 20,
                           text_str = "Change", label_rotated = true);
}
...
{
    SlidingBoxLidWithLabel(width = card_box_width, length = card_box_length, text_width = 50, text_height = 20,
                           text_str = "Legend", label_rotated = true);
}
...
{
    SlidingBoxLidWithLabel(width = card_box_width, length = card_box_length, text_width = 50, text_height = 20,
                           text_str = "Play", label_rotated = true);
}
...
module SpacerSide() // `make` me
{
    color(default_material_colour)
    {
        difference()
        {
            cuboid([ spacer_side_width, spacer_side_length, spacer_side_height ], anchor = BOTTOM + LEFT + FRONT,
                   rounding = 2);
            translate([ default_wall_thickness, default_wall_thickness, default_floor_thickness ])
            {
                cube([
                    spacer_side_width - default_wall_thickness * 2, spacer_side_length - default_wall_thickness * 2,
                    spacer_side_height
                ]);
            }
        }
...
module SpacerFront() // `make` me
{
    color(default_material_colour)
    {
        difference()
        {
            cuboid([ spacer_front_width, spacer_front_length, spacer_front_height ], anchor = BOTTOM + LEFT + FRONT,
                   rounding = 2);
            translate([ default_wall_thickness, default_wall_thickness, default_floor_thickness ])
            {
                cube([
                    spacer_front_width - default_wall_thickness * 2, spacer_front_length - default_wall_thickness * 2,
                    spacer_front_height
                ]);
            }
        }
...
module BoxLayout()
{
    ...
    //  translate([ 0, 0, board_thickness ])
    {
        ...
        translate([
            player_box_width + nest_box_width, card_box_length, starting_card_box_height + achievment_card_box_height
